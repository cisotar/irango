...
// /cadastro (issue 034). Validação client é só UX — a autoritativa está na
// action `cadastrar` (seguranca.md §6), que ignora qualquer campo injetado via
// schemaCadastro.strict(). Sem @hookform/resolvers → valida o schema zod
