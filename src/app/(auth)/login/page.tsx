...
// /login (issue 034). Validação client é só UX — a autoritativa está na action
// `entrar` (seguranca.md §6). Sem @hookform/resolvers instalado → valida com o
// schema zod manualmente no submit (mesmo schema do servidor).
